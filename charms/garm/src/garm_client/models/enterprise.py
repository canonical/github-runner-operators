...
class Enterprise(BaseModel):
    ...
    credentials_id: Optional[StrictInt] = None
    credentials_name: Optional[StrictStr] = Field(default=None, description="CredentialName is the name of the credentials associated with the enterprise. This field is now deprecated. Use CredentialsID instead. This field will be removed in v0.2.0.")
    endpoint: Optional[ForgeEndpoint] = None
    events: Optional[List[EntityEvent]] = None
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    pool: Optional[List[Pool]] = None
    pool_balancing_type: Optional[StrictStr] = None
    pool_manager_status: Optional[PoolManagerStatus] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["agent_mode", "created_at", "credentials", "credentials_id", "credentials_name", "endpoint", "events", "id", "name", "pool", "pool_balancing_type", "pool_manager_status", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "events": [EntityEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
            "pool": [Pool.from_dict(_item) for _item in obj["pool"]] if obj.get("pool") is not None else None,
...
Enterprise.model_rebuild(raise_errors=False)
