...
class Repository(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["agent_mode", "created_at", "credentials", "credentials_id", "credentials_name", "endpoint", "events", "id", "name", "owner", "pool", "pool_balancing_type", "pool_manager_status", "updated_at"]
