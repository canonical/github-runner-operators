...
class FileObjectPaginatedResponseResultsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["created_at", "description", "file_type", "id", "name", "sha256", "size", "tags", "updated_at"]
