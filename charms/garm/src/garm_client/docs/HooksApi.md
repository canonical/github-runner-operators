...
------------- | ------------- | -------------
[**get_forge_instance_webhook_info**](HooksApi.md#get_forge_instance_webhook_info) | **GET** /forge-instances/{forgeInstanceID}/webhook | Get information about the GARM installed webhook on a forge instance.
...
[**install_forge_instance_webhook**](HooksApi.md#install_forge_instance_webhook) | **POST** /forge-instances/{forgeInstanceID}/webhook | 
...
[**uninstall_forge_instance_webhook**](HooksApi.md#uninstall_forge_instance_webhook) | **DELETE** /forge-instances/{forgeInstanceID}/webhook | Uninstall forge instance webhook.
...
with garm_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HooksApi->get_forge_instance_webhook_info:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HooksApi->get_forge_instance_webhook_info: %s\n" % e)
```
...
with garm_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HooksApi->install_forge_instance_webhook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HooksApi->install_forge_instance_webhook: %s\n" % e)
```
...
with garm_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of HooksApi->uninstall_forge_instance_webhook:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling HooksApi->uninstall_forge_instance_webhook: %s\n" % e)
```
